...
public class BondTestSuite {
	...
	@DataProvider(name = "measures")
	public Object[][] measures() {
		return new Object[][] {
				new Object[]{ new String[]{ "eodcdsmeasures" } },
				new Object[]{ new String[]{ "eodcdssetmeasures" } },
				new Object[]{ new String[]{ "eodbondsetmeasures" } },
		};
	}
		...
		throws java.lang.Exception
	{
		...
		java.sql.Statement stmt = org.drip.service.env.EnvManager.InitEnv
			("build/resources/test/config.xml");
