...
public class BasisBSplineSet {
	...
	/*
	 * This org.drip.sample demonstrates construction and usage of B Spline hat functions over solitary segments. It
	...
	/*
	 * This org.drip.sample demonstrates the construction and usage of the Basis B Spline Set Functionality. It shows
	 * 	the following:
