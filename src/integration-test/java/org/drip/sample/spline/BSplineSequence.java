...
public class BSplineSequence {
	...
	/*
	 * This org.drip.sample shows the computation of the response value, the normalized cumulative, and the ordered
	...
	/*
	 * This org.drip.sample demonstrates the construction and usage of the following monic/multic basis spline arrays:
