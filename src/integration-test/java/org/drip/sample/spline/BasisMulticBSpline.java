...
public class BasisMulticBSpline {
	...
	/*
	 * This org.drip.sample illustrates the construction and the usage of multic basis functions, and their eventual
	...
	/*
	 * This org.drip.sample illustrates a sequence of tests using basis multic B Splines. In particular it shows the
	 * 	following:
