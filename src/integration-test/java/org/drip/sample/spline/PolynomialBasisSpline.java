...
public class PolynomialBasisSpline {
	...
	/*
	 * This org.drip.sample demonstrates the following specifically for the Ck Hermite Splines, which are calibrated
	...
	/*
	 * This org.drip.sample illustrates the construction and usage for polynomial basis splines. It shows the
	 * 	following:
