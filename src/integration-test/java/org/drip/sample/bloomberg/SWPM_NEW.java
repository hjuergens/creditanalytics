...
/**
 * SWPM_NEW contains the org.drip.sample demonstrating the replication of Bloomberg's Latest SWPM Functionality.
 * 
...
public class SWPM_NEW {
	...
	public static final ForwardCurve MakeForwardCurve (
		...
		final DiscountCurve dcOvernight,
		...
		throws Exception
	{
		...
		DiscountCurve dcOvernight = OvernightCurve (
			dtSpot,
			strCurrency,
