...
/**
 * YAS_DBR contains the org.drip.sample demonstrating the replication of Bloomberg's Deutsche EUR BUND YAS
 *  Functionality.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class YAS_DBR {
		...
		throws Exception
	{
		...
		double dblCoupon = 0.0175;
		double dblNotional = 1000000.;
		double dblCleanPrice = 1.13;
