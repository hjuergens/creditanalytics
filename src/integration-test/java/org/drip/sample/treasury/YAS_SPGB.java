...
/**
 * YAS_SPGB contains the org.drip.sample demonstrating the replication of Bloomberg's Spanish Govvie EUR Bond YAS
 *  Functionality.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class YAS_SPGB {
		...
		throws Exception
	{
		return BondBuilder.CreateSimpleFixed (
			"GGB " + FormatUtil.FormatDouble (dblCoupon, 1, 2, 100.) + " " + dtMaturity,
			strCurrency,
			"",
			dblCoupon,
			iFreq,
		...
		throws Exception
	{
		...
		double dblCoupon = 0.014;
		double dblNotional = 1000000.;
		double dblCleanPrice = 1.03775;
