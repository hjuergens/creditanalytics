...
/**
 * YAS_JGB contains the org.drip.sample demonstrating the replication of Bloomberg's Japanese JGB JPY Bond YAS
 * 	Functionality.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class YAS_JGB {
		...
		throws Exception
	{
		return BondBuilder.CreateSimpleFixed (
			"JGB " + FormatUtil.FormatDouble (dblCoupon, 1, 2, 100.) + " " + dtMaturity,
			strCurrency,
			"",
			dblCoupon,
			iFreq,
		...
		throws Exception
	{
		...
		int iFreq = 2;
		String strDayCount = "NL/365";
		String strCurrency = "JPY";
		double dblCoupon = 0.009;
		double dblNotional = 1000000.;
		double dblCleanPrice = 1.052;
