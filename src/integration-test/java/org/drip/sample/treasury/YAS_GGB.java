...
/**
 * YAS_GGB contains the org.drip.sample demonstrating the replication of Bloomberg's Greek Govvie EUR Bond YAS
 *  Functionality.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class YAS_GGB {
		...
		throws Exception
	{
		...
		double dblCoupon = 0.03375;
		double dblNotional = 1000000.;
		double dblCleanPrice = 0.7578;
