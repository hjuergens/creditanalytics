 ...
 *  provides for elaborate curve builder control, both at the segment level and at the Stretch level. In
 ...
 * 
 * In addition, the org.drip.sample demonstrates the following ways of controlling curve construction:
...
public class CustomCurveBuilder {
	...
	/*
	 * Generate the org.drip.sample Swap Cash Flows to a given maturity, for the frequency/coupon.
	...
	/*
	 * This org.drip.sample demonstrates the usage construction and usage of Custom Curve Building. It shows the following:
