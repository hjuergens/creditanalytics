...
/**
 * TensionStretchEstimator demonstrates the Stretch builder and usage API. It shows the following:
 ...
 * 	- Complete the full tension stretch estimation org.drip.sample test.
 *
 * @author Lakshmi Krishnamurthy
 */

public class TensionStretchEstimator {
	...
	/*
	 * Complete the full tension stretch estimation org.drip.sample test by doing the following:
