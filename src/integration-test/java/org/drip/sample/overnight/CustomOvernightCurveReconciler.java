...
public class CustomOvernightCurveReconciler {
	...
	/*
	 * This org.drip.sample demonstrates the multi-stretch transition custom discount curve construction, turns
		...
		throws Exception
	{
		...
		/*
		 * Runs the full spline linear discount curve builder org.drip.sample using the overnight index discount curve.
		 */
