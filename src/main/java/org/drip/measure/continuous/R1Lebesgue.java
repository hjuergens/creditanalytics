...
/**
 * R1Lebesgue implements the R^1 Lebesgue (i.e., Bounded Uniform) Distribution, with a Uniform Distribution
 *  between a Lower and an Upper Bound.
 *
 * @author Lakshmi Krishnamurthy
 */

public class R1Lebesgue extends org.drip.measure.continuous.R1 {
		...
		throws java.lang.Exception
	{
		if (!org.drip.quant.common.NumberUtil.IsValid (_dblLowerBound = dblLowerBound) ||
			!org.drip.quant.common.NumberUtil.IsValid (_dblUpperBound = dblUpperBound) || dblUpperBound <=
				dblLowerBound)
			throw new java.lang.Exception ("R1Lebesgue Constructor: Invalid Inputs");
	}
		...
		throws java.lang.Exception
	{
		if (!org.drip.quant.common.NumberUtil.IsValid (dblX))
			throw new java.lang.Exception ("R1Lebesgue::cumulative => Invalid Inputs");
		...
		throws java.lang.Exception
	{
		if (!org.drip.quant.common.NumberUtil.IsValid (dblY) || dblY < 0. || dblY > 1.)
			throw new java.lang.Exception ("R1Lebesgue::invCumulative => Invalid inputs");
