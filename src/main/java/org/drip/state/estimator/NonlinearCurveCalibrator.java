...
public class NonlinearCurveCalibrator {
	...
	private double calibrateIRCurve (
		...
		throws java.lang.Exception
	{
		org.drip.function.definition.R1ToR1 ofIROuter = new
		...
		final boolean bFlat)
	{
		...
		try {
			org.drip.function.solverR1ToR1.FixedPointFinderOutput rfop = new
				org.drip.function.solverR1ToR1.FixedPointFinderZheng (0., new CreditCurveCalibrator (cc, comp,
		...
		throws java.lang.Exception
	{
		...
		org.drip.function.definition.R1ToR1 ofIRNode = new
			org.drip.function.definition.R1ToR1 (null) {
			public double evaluate (
				final double dblValue)
				throws java.lang.Exception
		...
		org.drip.function.solverR1ToR1.FixedPointFinderOutput rfop = new
			org.drip.function.solverR1ToR1.FixedPointFinderBrent (0., ofIRNode, true).findRoot();
