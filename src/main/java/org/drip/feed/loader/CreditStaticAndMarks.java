...
class CreditStaticAndMarks {
		...
		final String[] astrValRecord)
	{
		...
		try {
			dblCoupon = new java.lang.Double (astrValRecord[5].trim()).doubleValue();
		} catch (java.lang.Exception e) {
			if (m_bBlog)
		...
		try {
			iCouponFreq = (int) new java.lang.Double (astrValRecord[11].trim()).doubleValue();
		} catch (java.lang.Exception e) {
			if (m_bBlog)
		...
		try {
			dblFloatSpread = new java.lang.Double (astrValRecord[14].trim()).doubleValue();
		} catch (java.lang.Exception e) {
			if (m_bBlog)
		...
		try {
			dblAmountIssued = new java.lang.Double (astrValRecord[24].trim()).doubleValue();
		} catch (java.lang.Exception e) {
			if (m_bBlog)
				System.out.println ("Bad issue amt " + astrValRecord[24] + " for ISIN " + strISIN);
		}

		double dblAmountOutstanding = 0.;

		try {
			dblAmountOutstanding = new java.lang.Double (astrValRecord[25].trim()).doubleValue();
		} catch (java.lang.Exception e) {
			if (m_bBlog)
