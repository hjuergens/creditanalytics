...
public class DC30E_360_ISDA implements org.drip.analytics.daycount.DCFCalculator {
	...
	{
		return "DC30E_360_ISDA";
	}

	@Override public String[] alternateNames()
	{
		return new String[] {"30E/360 ISDA", "30E/360 (ISDA)", "DC30E_360_ISDA"};
	}
	...
	{
		DateEOMAdjustment dm = DateEOMAdjustment.MakeDEOMA30E_360_ISDA (dblStart, dblEnd, bApplyEOMAdj);
