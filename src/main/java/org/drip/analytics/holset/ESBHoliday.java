...
public class ESBHoliday implements org.drip.analytics.holset.LocationHoliday {
	public ESBHoliday()
	{
	}
	...
	public org.drip.analytics.eventday.Locale getHolidaySet()
	{
		...
		lh.addStaticHoliday ("25-JUL-1997", "St James");

		lh.addStaticHoliday ("15-AUG-1997", "Assumption");
		...
		lh.addStaticHoliday ("11-JUN-1998", "Replacement");

		lh.addStaticHoliday ("12-OCT-1998", "National Holiday");

		lh.addStaticHoliday ("09-NOV-1998", "Almudena");

		lh.addStaticHoliday ("08-DEC-1998", "Immac Conception");
		...
		lh.addStaticHoliday ("03-JUN-1999", "Replacement");

		lh.addStaticHoliday ("12-OCT-1999", "National Holiday");

		lh.addStaticHoliday ("01-NOV-1999", "All Saints");

		lh.addStaticHoliday ("09-NOV-1999", "Alumenda");

		lh.addStaticHoliday ("06-DEC-1999", "Constitution");

		lh.addStaticHoliday ("08-DEC-1999", "Immac Conception");
		...
		lh.addStaticHoliday ("22-JUN-2000", "Replacement");

		lh.addStaticHoliday ("15-AUG-2000", "Assumption");

		lh.addStaticHoliday ("12-OCT-2000", "National Holiday");

		lh.addStaticHoliday ("01-NOV-2000", "All Saints");

		lh.addStaticHoliday ("09-NOV-2000", "Almudena");

		lh.addStaticHoliday ("06-DEC-2000", "Constitution");

		lh.addStaticHoliday ("08-DEC-2000", "Immac Conception");
		...
		lh.addStaticHoliday ("14-JUN-2001", "Replacement");

		lh.addStaticHoliday ("15-AUG-2001", "Assumption");

		lh.addStaticHoliday ("12-OCT-2001", "National Holiday");

		lh.addStaticHoliday ("01-NOV-2001", "All Saints");

		lh.addStaticHoliday ("09-NOV-2001", "Almudena");

		lh.addStaticHoliday ("06-DEC-2001", "Constitution");
		...
		lh.addStaticHoliday ("30-MAY-2002", "Replacement");

		lh.addStaticHoliday ("15-AUG-2002", "Assumption");

		lh.addStaticHoliday ("01-NOV-2002", "All Saints");

		lh.addStaticHoliday ("06-DEC-2002", "Constitution");
		...
		lh.addStaticHoliday ("19-JUN-2003", "Replacement");

		lh.addStaticHoliday ("15-AUG-2003", "Assumption");

		lh.addStaticHoliday ("08-DEC-2003", "Immac Conception");
