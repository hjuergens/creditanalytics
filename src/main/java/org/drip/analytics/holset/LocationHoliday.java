...
/**
 * LocationHoliday is an interface which is implemented by all the Location Holiday classes. It exposes the
 *  specific holiday location, as well as the set of location-specific holidays.
 *
