...
public class SARHoliday implements org.drip.analytics.holset.LocationHoliday {
	public SARHoliday()
	{
	}
	...
	public org.drip.analytics.eventday.Locale getHolidaySet()
	{
		...
		lh.addStaticHoliday ("27-JAN-1998", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("02-FEB-1998", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("03-FEB-1998", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("02-APR-1998", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("04-APR-1998", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("11-APR-1998", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("12-APR-1998", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("16-JAN-1999", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("23-JAN-1999", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("23-MAR-1999", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("24-MAR-1999", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("25-MAR-1999", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("31-MAR-1999", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("01-APR-1999", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("05-JAN-2000", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("11-JAN-2000", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("12-JAN-2000", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("11-MAR-2000", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("12-MAR-2000", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("13-MAR-2000", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("19-MAR-2000", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("20-MAR-2000", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("21-MAR-2000", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("24-DEC-2000", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("30-DEC-2000", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("31-DEC-2000", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("01-MAR-2001", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("03-MAR-2001", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("10-MAR-2001", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("11-MAR-2001", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("13-DEC-2001", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("19-DEC-2001", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("20-DEC-2001", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("18-FEB-2002", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("19-FEB-2002", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("20-FEB-2002", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("26-FEB-2002", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("27-FEB-2002", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("28-FEB-2002", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("03-DEC-2002", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("09-DEC-2002", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("10-DEC-2002", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("08-FEB-2003", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("09-FEB-2003", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("15-FEB-2003", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("16-FEB-2003", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("17-FEB-2003", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("22-NOV-2003", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("29-NOV-2003", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("27-JAN-2004", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("28-JAN-2004", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("29-JAN-2004", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("04-FEB-2004", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("05-FEB-2004", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("11-NOV-2004", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("17-NOV-2004", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("18-NOV-2004", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("16-JAN-2005", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("17-JAN-2005", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("18-JAN-2005", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("24-JAN-2005", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("25-JAN-2005", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("26-JAN-2005", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("31-OCT-2005", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("06-NOV-2005", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("07-NOV-2005", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("05-JAN-2006", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("07-JAN-2006", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("14-JAN-2006", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("15-JAN-2006", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("21-OCT-2006", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("28-OCT-2006", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("26-DEC-2006", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("27-DEC-2006", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("28-DEC-2006", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("03-JAN-2007", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("04-JAN-2007", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("10-OCT-2007", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("16-OCT-2007", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("17-OCT-2007", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("15-DEC-2007", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("16-DEC-2007", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("17-DEC-2007", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("23-DEC-2007", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("24-DEC-2007", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("25-DEC-2007", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("28-SEP-2008", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("04-OCT-2008", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("05-OCT-2008", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("03-DEC-2008", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("04-DEC-2008", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("11-DEC-2008", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("13-DEC-2008", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("17-SEP-2009", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("23-SEP-2009", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("24-SEP-2009", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("22-NOV-2009", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("23-NOV-2009", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("24-NOV-2009", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("30-NOV-2009", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("01-DEC-2009", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("02-DEC-2009", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("07-SEP-2010", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("13-SEP-2010", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("14-SEP-2010", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("13-NOV-2010", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("14-NOV-2010", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("20-NOV-2010", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("21-NOV-2010", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("22-NOV-2010", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("27-AUG-2011", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("03-SEP-2011", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("01-NOV-2011", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("02-NOV-2011", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("03-NOV-2011", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("09-NOV-2011", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("10-NOV-2011", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("16-AUG-2012", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("22-AUG-2012", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("23-AUG-2012", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("21-OCT-2012", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("22-OCT-2012", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("23-OCT-2012", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("29-OCT-2012", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("30-OCT-2012", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("31-OCT-2012", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("05-AUG-2013", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("11-AUG-2013", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("12-AUG-2013", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("10-OCT-2013", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("12-OCT-2013", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("19-OCT-2013", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("20-OCT-2013", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("26-JUL-2014", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("02-AUG-2014", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("30-SEP-2014", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("01-OCT-2014", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("02-OCT-2014", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("08-OCT-2014", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("09-OCT-2014", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("15-JUL-2015", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("21-JUL-2015", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("22-JUL-2015", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("19-SEP-2015", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("20-SEP-2015", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("21-SEP-2015", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("27-SEP-2015", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("28-SEP-2015", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("29-SEP-2015", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("03-JUL-2016", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("09-JUL-2016", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("10-JUL-2016", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("07-SEP-2016", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("08-SEP-2016", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("15-SEP-2016", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("17-SEP-2016", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("22-JUN-2017", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("28-JUN-2017", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("29-JUN-2017", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("27-AUG-2017", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("28-AUG-2017", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("29-AUG-2017", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("04-SEP-2017", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("05-SEP-2017", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("06-SEP-2017", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("12-JUN-2018", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("18-JUN-2018", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("19-JUN-2018", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("18-AUG-2018", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("19-AUG-2018", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("25-AUG-2018", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("26-AUG-2018", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("27-AUG-2018", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("02-JUN-2019", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("08-JUN-2019", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("09-JUN-2019", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("06-AUG-2019", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("07-AUG-2019", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("08-AUG-2019", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("14-AUG-2019", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("15-AUG-2019", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("21-MAY-2020", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("27-MAY-2020", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("28-MAY-2020", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("26-JUL-2020", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("27-JUL-2020", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("28-JUL-2020", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("03-AUG-2020", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("04-AUG-2020", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("05-AUG-2020", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("10-MAY-2021", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("16-MAY-2021", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("17-MAY-2021", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("15-JUL-2021", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("17-JUL-2021", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("24-JUL-2021", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("25-JUL-2021", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("05-MAY-2022", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("04-JUL-2022", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("05-JUL-2022", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("06-JUL-2022", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("12-JUL-2022", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("13-JUL-2022", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("14-JUL-2022", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("19-APR-2023", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("25-APR-2023", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("26-APR-2023", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("24-JUN-2023", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("25-JUN-2023", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("26-JUN-2023", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("02-JUL-2023", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("03-JUL-2023", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("04-JUL-2023", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("07-APR-2024", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("13-APR-2024", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("14-APR-2024", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("12-JUN-2024", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("13-JUN-2024", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("20-JUN-2024", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("22-JUN-2024", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("03-APR-2025", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("01-JUN-2025", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("02-JUN-2025", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("03-JUN-2025", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("09-JUN-2025", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("10-JUN-2025", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("11-JUN-2025", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("17-MAR-2026", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("23-MAR-2026", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("24-MAR-2026", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("23-MAY-2026", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("24-MAY-2026", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("30-MAY-2026", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("31-MAY-2026", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("01-JUN-2026", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("07-MAR-2027", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("13-MAR-2027", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("14-MAR-2027", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("12-MAY-2027", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("13-MAY-2027", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("20-MAY-2027", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("22-MAY-2027", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("24-FEB-2028", "Eid Al Fiter Holiday Period");
		...
		lh.addStaticHoliday ("01-MAR-2028", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("02-MAR-2028", "Eid Al Fiter Holiday Period");

		lh.addStaticHoliday ("30-APR-2028", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("01-MAY-2028", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("02-MAY-2028", "Eid Al Adha Holiday Period");
		...
		lh.addStaticHoliday ("08-MAY-2028", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("09-MAY-2028", "Eid Al Adha Holiday Period");

		lh.addStaticHoliday ("10-MAY-2028", "Eid Al Adha Holiday Period");
