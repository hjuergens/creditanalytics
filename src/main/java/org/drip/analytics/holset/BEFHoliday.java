...
public class BEFHoliday implements org.drip.analytics.holset.LocationHoliday {
	public BEFHoliday()
	{
	}
	...
	public org.drip.analytics.eventday.Locale getHolidaySet()
	{
		...
		lh.addStaticHoliday ("22-MAY-1998", "Bank Holiday");

		lh.addStaticHoliday ("01-JUN-1998", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-1998", "National Holiday");

		lh.addStaticHoliday ("17-AUG-1998", "Bridging Day");

		lh.addStaticHoliday ("02-NOV-1998", "Bridging Day");
		...
		lh.addStaticHoliday ("03-MAY-1999", "Bridging Day");

		lh.addStaticHoliday ("13-MAY-1999", "Ascension Day");

		lh.addStaticHoliday ("14-MAY-1999", "Bank Holiday");

		lh.addStaticHoliday ("24-MAY-1999", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-1999", "National Holiday");
		...
		lh.addStaticHoliday ("27-DEC-1999", "Bridging Day");

		lh.addStaticHoliday ("03-JAN-2000", "Bridging Day");
		...
		lh.addStaticHoliday ("02-JUN-2000", "Bank Holiday");

		lh.addStaticHoliday ("12-JUN-2000", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2000", "National Holiday");

		lh.addStaticHoliday ("15-AUG-2000", "Assumption Day");

		lh.addStaticHoliday ("01-NOV-2000", "All Saints Day");

		lh.addStaticHoliday ("13-NOV-2000", "Bridging Day");

		lh.addStaticHoliday ("25-DEC-2000", "Christmas Day");

		lh.addStaticHoliday ("26-DEC-2000", "Bridging Day");
		...
		lh.addStaticHoliday ("25-MAY-2001", "Bank Holiday");

		lh.addStaticHoliday ("04-JUN-2001", "Whit Monday");

		lh.addStaticHoliday ("23-JUL-2001", "Bridging Day");
		...
		lh.addStaticHoliday ("26-DEC-2001", "Bridging Day");
		...
		lh.addStaticHoliday ("10-MAY-2002", "Bank Holiday");

		lh.addStaticHoliday ("20-MAY-2002", "Whit Monday");

		lh.addStaticHoliday ("22-JUL-2002", "Bridging Day");
		...
		lh.addStaticHoliday ("26-DEC-2002", "Bridging Day");
		...
		lh.addStaticHoliday ("30-MAY-2003", "Bank Holiday");

		lh.addStaticHoliday ("09-JUN-2003", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2003", "National Holiday");

		lh.addStaticHoliday ("15-AUG-2003", "Assumption Day");

		lh.addStaticHoliday ("03-NOV-2003", "Bridging Day");
		...
		lh.addStaticHoliday ("03-MAY-2004", "Bridging Day");

		lh.addStaticHoliday ("20-MAY-2004", "Ascension Day");

		lh.addStaticHoliday ("21-MAY-2004", "Bank Holiday");

		lh.addStaticHoliday ("31-MAY-2004", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2004", "National Holiday");
		...
		lh.addStaticHoliday ("27-DEC-2004", "Bridging Day");

		lh.addStaticHoliday ("03-JAN-2005", "Bridging Day");
		...
		lh.addStaticHoliday ("06-MAY-2005", "Bank Holiday");

		lh.addStaticHoliday ("16-MAY-2005", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2005", "National Holiday");
		...
		lh.addStaticHoliday ("26-MAY-2006", "Bank Holiday");

		lh.addStaticHoliday ("05-JUN-2006", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2006", "National Holiday");

		lh.addStaticHoliday ("15-AUG-2006", "Assumption Day");

		lh.addStaticHoliday ("01-NOV-2006", "All Saints Day");

		lh.addStaticHoliday ("13-NOV-2006", "Bridging Day");

		lh.addStaticHoliday ("25-DEC-2006", "Christmas Day");

		lh.addStaticHoliday ("26-DEC-2006", "Bridging Day");
		...
		lh.addStaticHoliday ("18-MAY-2007", "Bank Holiday");

		lh.addStaticHoliday ("28-MAY-2007", "Whit Monday");

		lh.addStaticHoliday ("23-JUL-2007", "Bridging Day");
		...
		lh.addStaticHoliday ("26-DEC-2007", "Bridging Day");
		...
		lh.addStaticHoliday ("21-JUL-2008", "National Holiday");

		lh.addStaticHoliday ("15-AUG-2008", "Assumption Day");

		lh.addStaticHoliday ("03-NOV-2008", "Bridging Day");
		...
		lh.addStaticHoliday ("22-MAY-2009", "Bank Holiday");

		lh.addStaticHoliday ("01-JUN-2009", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2009", "National Holiday");

		lh.addStaticHoliday ("17-AUG-2009", "Bridging Day");
		...
		lh.addStaticHoliday ("03-MAY-2010", "Bridging Day");

		lh.addStaticHoliday ("13-MAY-2010", "Ascension Day");

		lh.addStaticHoliday ("14-MAY-2010", "Bank Holiday");

		lh.addStaticHoliday ("24-MAY-2010", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2010", "National Holiday");
		...
		lh.addStaticHoliday ("27-DEC-2010", "Bridging Day");

		lh.addStaticHoliday ("03-JAN-2011", "Bridging Day");
		...
		lh.addStaticHoliday ("03-JUN-2011", "Bank Holiday");

		lh.addStaticHoliday ("13-JUN-2011", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2011", "National Holiday");
		...
		lh.addStaticHoliday ("18-MAY-2012", "Bank Holiday");

		lh.addStaticHoliday ("28-MAY-2012", "Whit Monday");

		lh.addStaticHoliday ("23-JUL-2012", "Bridging Day");
		...
		lh.addStaticHoliday ("26-DEC-2012", "Bridging Day");
		...
		lh.addStaticHoliday ("10-MAY-2013", "Bank Holiday");

		lh.addStaticHoliday ("20-MAY-2013", "Whit Monday");

		lh.addStaticHoliday ("22-JUL-2013", "Bridging Day");
		...
		lh.addStaticHoliday ("26-DEC-2013", "Bridging Day");
		...
		lh.addStaticHoliday ("30-MAY-2014", "Bank Holiday");

		lh.addStaticHoliday ("09-JUN-2014", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2014", "National Holiday");

		lh.addStaticHoliday ("15-AUG-2014", "Assumption Day");

		lh.addStaticHoliday ("03-NOV-2014", "Bridging Day");
		...
		lh.addStaticHoliday ("15-MAY-2015", "Bank Holiday");

		lh.addStaticHoliday ("25-MAY-2015", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2015", "National Holiday");

		lh.addStaticHoliday ("17-AUG-2015", "Bridging Day");
		...
		lh.addStaticHoliday ("06-MAY-2016", "Bank Holiday");

		lh.addStaticHoliday ("16-MAY-2016", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2016", "National Holiday");
		...
		lh.addStaticHoliday ("26-MAY-2017", "Bank Holiday");

		lh.addStaticHoliday ("05-JUN-2017", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2017", "National Holiday");

		lh.addStaticHoliday ("15-AUG-2017", "Assumption Day");

		lh.addStaticHoliday ("01-NOV-2017", "All Saints Day");

		lh.addStaticHoliday ("13-NOV-2017", "Bridging Day");

		lh.addStaticHoliday ("25-DEC-2017", "Christmas Day");

		lh.addStaticHoliday ("26-DEC-2017", "Bridging Day");
		...
		lh.addStaticHoliday ("11-MAY-2018", "Bank Holiday");

		lh.addStaticHoliday ("21-MAY-2018", "Whit Monday");

		lh.addStaticHoliday ("23-JUL-2018", "Bridging Day");
		...
		lh.addStaticHoliday ("26-DEC-2018", "Bridging Day");
		...
		lh.addStaticHoliday ("31-MAY-2019", "Bank Holiday");

		lh.addStaticHoliday ("10-JUN-2019", "Whit Monday");

		lh.addStaticHoliday ("22-JUL-2019", "Bridging Day");
		...
		lh.addStaticHoliday ("26-DEC-2019", "Bridging Day");
		...
		lh.addStaticHoliday ("22-MAY-2020", "Bank Holiday");

		lh.addStaticHoliday ("01-JUN-2020", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2020", "National Holiday");

		lh.addStaticHoliday ("17-AUG-2020", "Bridging Day");
		...
		lh.addStaticHoliday ("03-MAY-2021", "Bridging Day");

		lh.addStaticHoliday ("13-MAY-2021", "Ascension Day");

		lh.addStaticHoliday ("14-MAY-2021", "Bank Holiday");

		lh.addStaticHoliday ("24-MAY-2021", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2021", "National Holiday");
		...
		lh.addStaticHoliday ("27-DEC-2021", "Bridging Day");

		lh.addStaticHoliday ("03-JAN-2022", "Bridging Day");
		...
		lh.addStaticHoliday ("27-MAY-2022", "Bank Holiday");

		lh.addStaticHoliday ("06-JUN-2022", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2022", "National Holiday");
		...
		lh.addStaticHoliday ("19-MAY-2023", "Bank Holiday");

		lh.addStaticHoliday ("29-MAY-2023", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2023", "National Holiday");

		lh.addStaticHoliday ("15-AUG-2023", "Assumption Day");

		lh.addStaticHoliday ("01-NOV-2023", "All Saints Day");

		lh.addStaticHoliday ("13-NOV-2023", "Bridging Day");

		lh.addStaticHoliday ("25-DEC-2023", "Christmas Day");

		lh.addStaticHoliday ("26-DEC-2023", "Bridging Day");
		...
		lh.addStaticHoliday ("10-MAY-2024", "Bank Holiday");

		lh.addStaticHoliday ("20-MAY-2024", "Whit Monday");

		lh.addStaticHoliday ("22-JUL-2024", "Bridging Day");
		...
		lh.addStaticHoliday ("26-DEC-2024", "Bridging Day");
		...
		lh.addStaticHoliday ("30-MAY-2025", "Bank Holiday");

		lh.addStaticHoliday ("09-JUN-2025", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2025", "National Holiday");

		lh.addStaticHoliday ("15-AUG-2025", "Assumption Day");

		lh.addStaticHoliday ("03-NOV-2025", "Bridging Day");
		...
		lh.addStaticHoliday ("15-MAY-2026", "Bank Holiday");

		lh.addStaticHoliday ("25-MAY-2026", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2026", "National Holiday");

		lh.addStaticHoliday ("17-AUG-2026", "Bridging Day");
		...
		lh.addStaticHoliday ("03-MAY-2027", "Bridging Day");

		lh.addStaticHoliday ("06-MAY-2027", "Ascension Day");

		lh.addStaticHoliday ("07-MAY-2027", "Bank Holiday");

		lh.addStaticHoliday ("17-MAY-2027", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2027", "National Holiday");
		...
		lh.addStaticHoliday ("27-DEC-2027", "Bridging Day");

		lh.addStaticHoliday ("03-JAN-2028", "Bridging Day");
		...
		lh.addStaticHoliday ("26-MAY-2028", "Bank Holiday");

		lh.addStaticHoliday ("05-JUN-2028", "Whit Monday");

		lh.addStaticHoliday ("21-JUL-2028", "National Holiday");

		lh.addStaticHoliday ("15-AUG-2028", "Assumption Day");

		lh.addStaticHoliday ("01-NOV-2028", "All Saints Day");

		lh.addStaticHoliday ("13-NOV-2028", "Bridging Day");

		lh.addStaticHoliday ("25-DEC-2028", "Christmas Day");

		lh.addStaticHoliday ("26-DEC-2028", "Bridging Day");
