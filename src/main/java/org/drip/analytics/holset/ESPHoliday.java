...
public class ESPHoliday implements org.drip.analytics.holset.LocationHoliday {
	public ESPHoliday()
	{
	}
	...
	public org.drip.analytics.eventday.Locale getHolidaySet()
	{
		...
		lh.addStaticHoliday ("02-MAY-2028", "Madrid Day");

		lh.addStaticHoliday ("15-MAY-2028", "San Isidro");

		lh.addStaticHoliday ("15-JUN-2028", "Corpus Christi");

		lh.addStaticHoliday ("25-JUL-2028", "St. James Day");

		lh.addStaticHoliday ("15-AUG-2028", "Assumption Day");

		lh.addStaticHoliday ("12-OCT-2028", "National Holiday");

		lh.addStaticHoliday ("01-NOV-2028", "All Saints Day");

		lh.addStaticHoliday ("09-NOV-2028", "Our Lady of Almudena");

		lh.addStaticHoliday ("06-DEC-2028", "Constitution Day");
