...
public class EEKHoliday implements org.drip.analytics.holset.LocationHoliday {
	public EEKHoliday()
	{
	}
	...
	public org.drip.analytics.eventday.Locale getHolidaySet()
	{
		...
		lh.addStaticHoliday ("24-FEB-1998", "Independence Day");

		lh.addStaticHoliday ("10-APR-1998", "Good Friday");

		lh.addStaticHoliday ("01-MAY-1998", "Spring Day");

		lh.addStaticHoliday ("23-JUN-1998", "Victory Day");

		lh.addStaticHoliday ("24-JUN-1998", "St. Johns Day");

		lh.addStaticHoliday ("20-AUG-1998", "Restoration of Independence Day");

		lh.addStaticHoliday ("25-DEC-1998", "Christmas Day");

		lh.addStaticHoliday ("01-JAN-1999", "New Years Day");

		lh.addStaticHoliday ("24-FEB-1999", "Independence Day");

		lh.addStaticHoliday ("02-APR-1999", "Good Friday");

		lh.addStaticHoliday ("23-JUN-1999", "Victory Day");

		lh.addStaticHoliday ("24-JUN-1999", "St. Johns Day");

		lh.addStaticHoliday ("24-FEB-2000", "Independence Day");

		lh.addStaticHoliday ("21-APR-2000", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2000", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2000", "Victory Day");
		...
		lh.addStaticHoliday ("01-MAY-2001", "Spring Day");
		...
		lh.addStaticHoliday ("01-MAY-2002", "Spring Day");

		lh.addStaticHoliday ("24-JUN-2002", "St. Johns Day");
		...
		lh.addStaticHoliday ("24-FEB-2003", "Independence Day");

		lh.addStaticHoliday ("18-APR-2003", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2003", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2003", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2003", "St. Johns Day");
		...
		lh.addStaticHoliday ("24-FEB-2004", "Independence Day");

		lh.addStaticHoliday ("09-APR-2004", "Good Friday");

		lh.addStaticHoliday ("23-JUN-2004", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2004", "St. Johns Day");

		lh.addStaticHoliday ("24-FEB-2005", "Independence Day");

		lh.addStaticHoliday ("25-MAR-2005", "Good Friday");

		lh.addStaticHoliday ("23-JUN-2005", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2005", "St. Johns Day");

		lh.addStaticHoliday ("26-DEC-2005", "Boxing Day");

		lh.addStaticHoliday ("24-FEB-2006", "Independence Day");

		lh.addStaticHoliday ("14-APR-2006", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2006", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2006", "Victory Day");
		...
		lh.addStaticHoliday ("01-MAY-2007", "Spring Day");
		...
		lh.addStaticHoliday ("01-MAY-2008", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2008", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2008", "St. Johns Day");
		...
		lh.addStaticHoliday ("24-FEB-2009", "Independence Day");

		lh.addStaticHoliday ("10-APR-2009", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2009", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2009", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2009", "St. Johns Day");

		lh.addStaticHoliday ("25-DEC-2009", "Christmas Day");

		lh.addStaticHoliday ("01-JAN-2010", "New Years Day");

		lh.addStaticHoliday ("24-FEB-2010", "Independence Day");

		lh.addStaticHoliday ("02-APR-2010", "Good Friday");

		lh.addStaticHoliday ("23-JUN-2010", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2010", "St. Johns Day");

		lh.addStaticHoliday ("24-FEB-2011", "Independence Day");

		lh.addStaticHoliday ("22-APR-2011", "Good Friday");

		lh.addStaticHoliday ("23-JUN-2011", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2011", "St. Johns Day");

		lh.addStaticHoliday ("26-DEC-2011", "Boxing Day");

		lh.addStaticHoliday ("24-FEB-2012", "Independence Day");

		lh.addStaticHoliday ("06-APR-2012", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2012", "Spring Day");
		...
		lh.addStaticHoliday ("01-MAY-2013", "Spring Day");

		lh.addStaticHoliday ("24-JUN-2013", "St. Johns Day");
		...
		lh.addStaticHoliday ("24-FEB-2014", "Independence Day");

		lh.addStaticHoliday ("18-APR-2014", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2014", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2014", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2014", "St. Johns Day");
		...
		lh.addStaticHoliday ("24-FEB-2015", "Independence Day");

		lh.addStaticHoliday ("03-APR-2015", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2015", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2015", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2015", "St. Johns Day");

		lh.addStaticHoliday ("25-DEC-2015", "Christmas Day");

		lh.addStaticHoliday ("01-JAN-2016", "New Years Day");

		lh.addStaticHoliday ("24-FEB-2016", "Independence Day");

		lh.addStaticHoliday ("25-MAR-2016", "Good Friday");

		lh.addStaticHoliday ("23-JUN-2016", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2016", "St. Johns Day");

		lh.addStaticHoliday ("26-DEC-2016", "Boxing Day");

		lh.addStaticHoliday ("24-FEB-2017", "Independence Day");

		lh.addStaticHoliday ("14-APR-2017", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2017", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2017", "Victory Day");
		...
		lh.addStaticHoliday ("01-MAY-2018", "Spring Day");
		...
		lh.addStaticHoliday ("01-MAY-2019", "Spring Day");

		lh.addStaticHoliday ("24-JUN-2019", "St. Johns Day");
		...
		lh.addStaticHoliday ("24-FEB-2020", "Independence Day");

		lh.addStaticHoliday ("10-APR-2020", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2020", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2020", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2020", "St. Johns Day");

		lh.addStaticHoliday ("25-DEC-2020", "Christmas Day");

		lh.addStaticHoliday ("01-JAN-2021", "New Years Day");

		lh.addStaticHoliday ("24-FEB-2021", "Independence Day");

		lh.addStaticHoliday ("02-APR-2021", "Good Friday");

		lh.addStaticHoliday ("23-JUN-2021", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2021", "St. Johns Day");

		lh.addStaticHoliday ("24-FEB-2022", "Independence Day");

		lh.addStaticHoliday ("15-APR-2022", "Good Friday");

		lh.addStaticHoliday ("23-JUN-2022", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2022", "St. Johns Day");

		lh.addStaticHoliday ("26-DEC-2022", "Boxing Day");

		lh.addStaticHoliday ("24-FEB-2023", "Independence Day");

		lh.addStaticHoliday ("07-APR-2023", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2023", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2023", "Victory Day");
		...
		lh.addStaticHoliday ("01-MAY-2024", "Spring Day");

		lh.addStaticHoliday ("24-JUN-2024", "St. Johns Day");
		...
		lh.addStaticHoliday ("24-FEB-2025", "Independence Day");

		lh.addStaticHoliday ("18-APR-2025", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2025", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2025", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2025", "St. Johns Day");
		...
		lh.addStaticHoliday ("24-FEB-2026", "Independence Day");

		lh.addStaticHoliday ("03-APR-2026", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2026", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2026", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2026", "St. Johns Day");

		lh.addStaticHoliday ("25-DEC-2026", "Christmas Day");

		lh.addStaticHoliday ("01-JAN-2027", "New Years Day");

		lh.addStaticHoliday ("24-FEB-2027", "Independence Day");

		lh.addStaticHoliday ("26-MAR-2027", "Good Friday");

		lh.addStaticHoliday ("23-JUN-2027", "Victory Day");

		lh.addStaticHoliday ("24-JUN-2027", "St. Johns Day");

		lh.addStaticHoliday ("24-FEB-2028", "Independence Day");

		lh.addStaticHoliday ("14-APR-2028", "Good Friday");

		lh.addStaticHoliday ("01-MAY-2028", "Spring Day");

		lh.addStaticHoliday ("23-JUN-2028", "Victory Day");
