...
public class ZWDHoliday implements org.drip.analytics.holset.LocationHoliday {
	public ZWDHoliday()
	{
	}
	...
	public org.drip.analytics.eventday.Locale getHolidaySet()
	{
		...
		lh.addStaticHoliday ("25-MAY-1998", "Africa Day");

		lh.addStaticHoliday ("11-AUG-1998", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-1998", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-1998", "Unity Day");
		...
		lh.addStaticHoliday ("19-APR-1999", "Independence Day Observed");

		lh.addStaticHoliday ("25-MAY-1999", "Africa Day");

		lh.addStaticHoliday ("11-AUG-1999", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-1999", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-1999", "Unity Day");

		lh.addStaticHoliday ("27-DEC-1999", "Boxing Day Observed");

		lh.addStaticHoliday ("18-APR-2000", "Independence Day");
		...
		lh.addStaticHoliday ("25-MAY-2000", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2000", "Heroes Day");

		lh.addStaticHoliday ("22-DEC-2000", "Unity Day");
		...
		lh.addStaticHoliday ("18-APR-2001", "Independence Day");

		lh.addStaticHoliday ("01-MAY-2001", "Workers Day");

		lh.addStaticHoliday ("25-MAY-2001", "Africa Day");

		lh.addStaticHoliday ("13-AUG-2001", "Defense Forces Day Observed");
		...
		lh.addStaticHoliday ("18-APR-2002", "Independence Day");

		lh.addStaticHoliday ("01-MAY-2002", "Workers Day");

		lh.addStaticHoliday ("12-AUG-2002", "Defense Forces Day");

		lh.addStaticHoliday ("23-DEC-2002", "Unity Day Observed");
		...
		lh.addStaticHoliday ("18-APR-2003", "Independence Day");

		lh.addStaticHoliday ("21-APR-2003", "Easter Monday");

		lh.addStaticHoliday ("01-MAY-2003", "Workers Day");

		lh.addStaticHoliday ("26-MAY-2003", "Africa Day Observed");

		lh.addStaticHoliday ("11-AUG-2003", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2003", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2003", "Unity Day");
		...
		lh.addStaticHoliday ("19-APR-2004", "Independence Day Observed");

		lh.addStaticHoliday ("25-MAY-2004", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2004", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2004", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2004", "Unity Day");
		...
		lh.addStaticHoliday ("18-APR-2005", "Independence Day");

		lh.addStaticHoliday ("02-MAY-2005", "Workers Day Observed");

		lh.addStaticHoliday ("25-MAY-2005", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2005", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2005", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2005", "Unity Day");
		...
		lh.addStaticHoliday ("18-APR-2006", "Independence Day");

		lh.addStaticHoliday ("01-MAY-2006", "Workers Day");

		lh.addStaticHoliday ("25-MAY-2006", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2006", "Heroes Day");

		lh.addStaticHoliday ("22-DEC-2006", "Unity Day");
		...
		lh.addStaticHoliday ("18-APR-2007", "Independence Day");

		lh.addStaticHoliday ("01-MAY-2007", "Workers Day");

		lh.addStaticHoliday ("25-MAY-2007", "Africa Day");

		lh.addStaticHoliday ("13-AUG-2007", "Defense Forces Day Observed");
		...
		lh.addStaticHoliday ("18-APR-2008", "Independence Day");

		lh.addStaticHoliday ("01-MAY-2008", "Workers Day");

		lh.addStaticHoliday ("26-MAY-2008", "Africa Day Observed");

		lh.addStaticHoliday ("11-AUG-2008", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2008", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2008", "Unity Day");
		...
		lh.addStaticHoliday ("25-MAY-2009", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2009", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2009", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2009", "Unity Day");
		...
		lh.addStaticHoliday ("19-APR-2010", "Independence Day Observed");

		lh.addStaticHoliday ("25-MAY-2010", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2010", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2010", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2010", "Unity Day");

		lh.addStaticHoliday ("27-DEC-2010", "Boxing Day Observed");

		lh.addStaticHoliday ("18-APR-2011", "Independence Day");
		...
		lh.addStaticHoliday ("25-MAY-2011", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2011", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2011", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2011", "Unity Day");
		...
		lh.addStaticHoliday ("18-APR-2012", "Independence Day");

		lh.addStaticHoliday ("01-MAY-2012", "Workers Day");

		lh.addStaticHoliday ("25-MAY-2012", "Africa Day");

		lh.addStaticHoliday ("13-AUG-2012", "Defense Forces Day Observed");
		...
		lh.addStaticHoliday ("18-APR-2013", "Independence Day");

		lh.addStaticHoliday ("01-MAY-2013", "Workers Day");

		lh.addStaticHoliday ("12-AUG-2013", "Defense Forces Day");

		lh.addStaticHoliday ("23-DEC-2013", "Unity Day Observed");
		...
		lh.addStaticHoliday ("18-APR-2014", "Independence Day");

		lh.addStaticHoliday ("21-APR-2014", "Easter Monday");

		lh.addStaticHoliday ("01-MAY-2014", "Workers Day");

		lh.addStaticHoliday ("26-MAY-2014", "Africa Day Observed");

		lh.addStaticHoliday ("11-AUG-2014", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2014", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2014", "Unity Day");
		...
		lh.addStaticHoliday ("25-MAY-2015", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2015", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2015", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2015", "Unity Day");
		...
		lh.addStaticHoliday ("18-APR-2016", "Independence Day");

		lh.addStaticHoliday ("02-MAY-2016", "Workers Day Observed");

		lh.addStaticHoliday ("25-MAY-2016", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2016", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2016", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2016", "Unity Day");
		...
		lh.addStaticHoliday ("18-APR-2017", "Independence Day");

		lh.addStaticHoliday ("01-MAY-2017", "Workers Day");

		lh.addStaticHoliday ("25-MAY-2017", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2017", "Heroes Day");

		lh.addStaticHoliday ("22-DEC-2017", "Unity Day");
		...
		lh.addStaticHoliday ("18-APR-2018", "Independence Day");

		lh.addStaticHoliday ("01-MAY-2018", "Workers Day");

		lh.addStaticHoliday ("25-MAY-2018", "Africa Day");

		lh.addStaticHoliday ("13-AUG-2018", "Defense Forces Day Observed");
		...
		lh.addStaticHoliday ("18-APR-2019", "Independence Day");
		...
		lh.addStaticHoliday ("12-AUG-2019", "Defense Forces Day");

		lh.addStaticHoliday ("23-DEC-2019", "Unity Day Observed");
		...
		lh.addStaticHoliday ("25-MAY-2020", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2020", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2020", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2020", "Unity Day");
		...
		lh.addStaticHoliday ("19-APR-2021", "Independence Day Observed");

		lh.addStaticHoliday ("25-MAY-2021", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2021", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2021", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2021", "Unity Day");

		lh.addStaticHoliday ("27-DEC-2021", "Boxing Day Observed");

		lh.addStaticHoliday ("15-APR-2022", "Good Friday");

		lh.addStaticHoliday ("18-APR-2022", "Independence Day");

		lh.addStaticHoliday ("02-MAY-2022", "Workers Day Observed");

		lh.addStaticHoliday ("25-MAY-2022", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2022", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2022", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2022", "Unity Day");
		...
		lh.addStaticHoliday ("18-APR-2023", "Independence Day");

		lh.addStaticHoliday ("01-MAY-2023", "Workers Day");

		lh.addStaticHoliday ("25-MAY-2023", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2023", "Heroes Day");

		lh.addStaticHoliday ("22-DEC-2023", "Unity Day");
		...
		lh.addStaticHoliday ("18-APR-2024", "Independence Day");

		lh.addStaticHoliday ("01-MAY-2024", "Workers Day");

		lh.addStaticHoliday ("12-AUG-2024", "Defense Forces Day");

		lh.addStaticHoliday ("23-DEC-2024", "Unity Day Observed");
		...
		lh.addStaticHoliday ("18-APR-2025", "Independence Day");

		lh.addStaticHoliday ("21-APR-2025", "Easter Monday");

		lh.addStaticHoliday ("01-MAY-2025", "Workers Day");

		lh.addStaticHoliday ("26-MAY-2025", "Africa Day Observed");

		lh.addStaticHoliday ("11-AUG-2025", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2025", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2025", "Unity Day");
		...
		lh.addStaticHoliday ("25-MAY-2026", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2026", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2026", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2026", "Unity Day");
		...
		lh.addStaticHoliday ("19-APR-2027", "Independence Day Observed");

		lh.addStaticHoliday ("25-MAY-2027", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2027", "Heroes Day");

		lh.addStaticHoliday ("12-AUG-2027", "Defense Forces Day");

		lh.addStaticHoliday ("22-DEC-2027", "Unity Day");
		...
		lh.addStaticHoliday ("18-APR-2028", "Independence Day");

		lh.addStaticHoliday ("01-MAY-2028", "Workers Day");

		lh.addStaticHoliday ("25-MAY-2028", "Africa Day");

		lh.addStaticHoliday ("11-AUG-2028", "Heroes Day");

		lh.addStaticHoliday ("22-DEC-2028", "Unity Day");
