...
public class LTLHoliday implements org.drip.analytics.holset.LocationHoliday {
	public LTLHoliday()
	{
	}
	...
	public org.drip.analytics.eventday.Locale getHolidaySet()
	{
		...
		lh.addStaticHoliday ("16-FEB-1998", "Independence Day");

		lh.addStaticHoliday ("11-MAR-1998", "Restoration of Independence Day");

		lh.addStaticHoliday ("13-APR-1998", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-1998", "Statehood Day");

		lh.addStaticHoliday ("25-DEC-1998", "Christmas Day");

		lh.addStaticHoliday ("01-JAN-1999", "New Years Day");

		lh.addStaticHoliday ("16-FEB-1999", "Independence Day");

		lh.addStaticHoliday ("11-MAR-1999", "Restoration of Independence Day");

		lh.addStaticHoliday ("05-APR-1999", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-1999", "Statehood Day");

		lh.addStaticHoliday ("01-NOV-1999", "All Saints Day");

		lh.addStaticHoliday ("16-FEB-2000", "Independence Day");

		lh.addStaticHoliday ("24-APR-2000", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2000", "Statehood Day");
		...
		lh.addStaticHoliday ("16-FEB-2001", "Independence Day");

		lh.addStaticHoliday ("16-APR-2001", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2001", "Statehood Day");
		...
		lh.addStaticHoliday ("11-MAR-2002", "Restoration of Independence Day");
		...
		lh.addStaticHoliday ("11-MAR-2003", "Restoration of Independence Day");
		...
		lh.addStaticHoliday ("16-FEB-2004", "Independence Day");

		lh.addStaticHoliday ("11-MAR-2004", "Restoration of Independence Day");

		lh.addStaticHoliday ("12-APR-2004", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2004", "Statehood Day");

		lh.addStaticHoliday ("01-NOV-2004", "All Saints Day");

		lh.addStaticHoliday ("16-FEB-2005", "Independence Day");

		lh.addStaticHoliday ("11-MAR-2005", "Restoration of Independence Day");

		lh.addStaticHoliday ("28-MAR-2005", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2005", "Statehood Day");

		lh.addStaticHoliday ("01-NOV-2005", "All Saints Day");

		lh.addStaticHoliday ("26-DEC-2005", "Christmas Holiday");

		lh.addStaticHoliday ("16-FEB-2006", "Independence Day");

		lh.addStaticHoliday ("17-APR-2006", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2006", "Statehood Day");
		...
		lh.addStaticHoliday ("16-FEB-2007", "Independence Day");

		lh.addStaticHoliday ("09-APR-2007", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2007", "Statehood Day");
		...
		lh.addStaticHoliday ("11-MAR-2008", "Restoration of Independence Day");
		...
		lh.addStaticHoliday ("16-FEB-2009", "Independence Day");

		lh.addStaticHoliday ("11-MAR-2009", "Restoration of Independence Day");

		lh.addStaticHoliday ("13-APR-2009", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2009", "Statehood Day");

		lh.addStaticHoliday ("25-DEC-2009", "Christmas Day");

		lh.addStaticHoliday ("01-JAN-2010", "New Years Day");

		lh.addStaticHoliday ("16-FEB-2010", "Independence Day");

		lh.addStaticHoliday ("11-MAR-2010", "Restoration of Independence Day");

		lh.addStaticHoliday ("05-APR-2010", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2010", "Statehood Day");

		lh.addStaticHoliday ("01-NOV-2010", "All Saints Day");

		lh.addStaticHoliday ("16-FEB-2011", "Independence Day");

		lh.addStaticHoliday ("11-MAR-2011", "Restoration of Independence Day");

		lh.addStaticHoliday ("25-APR-2011", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2011", "Statehood Day");

		lh.addStaticHoliday ("01-NOV-2011", "All Saints Day");

		lh.addStaticHoliday ("26-DEC-2011", "Christmas Holiday");

		lh.addStaticHoliday ("16-FEB-2012", "Independence Day");

		lh.addStaticHoliday ("09-APR-2012", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2012", "Statehood Day");
		...
		lh.addStaticHoliday ("11-MAR-2013", "Restoration of Independence Day");
		...
		lh.addStaticHoliday ("11-MAR-2014", "Restoration of Independence Day");
		...
		lh.addStaticHoliday ("16-FEB-2015", "Independence Day");

		lh.addStaticHoliday ("11-MAR-2015", "Restoration of Independence Day");

		lh.addStaticHoliday ("06-APR-2015", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2015", "Statehood Day");

		lh.addStaticHoliday ("25-DEC-2015", "Christmas Day");

		lh.addStaticHoliday ("01-JAN-2016", "New Years Day");

		lh.addStaticHoliday ("16-FEB-2016", "Independence Day");

		lh.addStaticHoliday ("11-MAR-2016", "Restoration of Independence Day");

		lh.addStaticHoliday ("28-MAR-2016", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2016", "Statehood Day");

		lh.addStaticHoliday ("01-NOV-2016", "All Saints Day");

		lh.addStaticHoliday ("26-DEC-2016", "Christmas Holiday");

		lh.addStaticHoliday ("16-FEB-2017", "Independence Day");

		lh.addStaticHoliday ("17-APR-2017", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2017", "Statehood Day");
		...
		lh.addStaticHoliday ("16-FEB-2018", "Independence Day");

		lh.addStaticHoliday ("02-APR-2018", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2018", "Statehood Day");
		...
		lh.addStaticHoliday ("11-MAR-2019", "Restoration of Independence Day");
		...
		lh.addStaticHoliday ("11-MAR-2020", "Restoration of Independence Day");

		lh.addStaticHoliday ("13-APR-2020", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2020", "Statehood Day");

		lh.addStaticHoliday ("25-DEC-2020", "Christmas Day");

		lh.addStaticHoliday ("01-JAN-2021", "New Years Day");

		lh.addStaticHoliday ("16-FEB-2021", "Independence Day");

		lh.addStaticHoliday ("11-MAR-2021", "Restoration of Independence Day");

		lh.addStaticHoliday ("05-APR-2021", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2021", "Statehood Day");

		lh.addStaticHoliday ("01-NOV-2021", "All Saints Day");

		lh.addStaticHoliday ("16-FEB-2022", "Independence Day");

		lh.addStaticHoliday ("11-MAR-2022", "Restoration of Independence Day");

		lh.addStaticHoliday ("18-APR-2022", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2022", "Statehood Day");

		lh.addStaticHoliday ("01-NOV-2022", "All Saints Day");

		lh.addStaticHoliday ("26-DEC-2022", "Christmas Holiday");

		lh.addStaticHoliday ("16-FEB-2023", "Independence Day");

		lh.addStaticHoliday ("10-APR-2023", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2023", "Statehood Day");
		...
		lh.addStaticHoliday ("16-FEB-2024", "Independence Day");

		lh.addStaticHoliday ("11-MAR-2024", "Restoration of Independence Day");
		...
		lh.addStaticHoliday ("11-MAR-2025", "Restoration of Independence Day");
		...
		lh.addStaticHoliday ("16-FEB-2026", "Independence Day");

		lh.addStaticHoliday ("11-MAR-2026", "Restoration of Independence Day");

		lh.addStaticHoliday ("06-APR-2026", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2026", "Statehood Day");

		lh.addStaticHoliday ("25-DEC-2026", "Christmas Day");

		lh.addStaticHoliday ("01-JAN-2027", "New Years Day");

		lh.addStaticHoliday ("16-FEB-2027", "Independence Day");

		lh.addStaticHoliday ("11-MAR-2027", "Restoration of Independence Day");

		lh.addStaticHoliday ("29-MAR-2027", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2027", "Statehood Day");

		lh.addStaticHoliday ("01-NOV-2027", "All Saints Day");

		lh.addStaticHoliday ("16-FEB-2028", "Independence Day");

		lh.addStaticHoliday ("17-APR-2028", "Easter Monday");

		lh.addStaticHoliday ("06-JUL-2028", "Statehood Day");
