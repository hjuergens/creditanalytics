...
public class LVLHoliday implements org.drip.analytics.holset.LocationHoliday {
	public LVLHoliday()
	{
	}
	...
	public org.drip.analytics.eventday.Locale getHolidaySet()
	{
		...
		lh.addStaticHoliday ("23-JUN-1998", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-1998", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-1998", "Independence Day");
		...
		lh.addStaticHoliday ("23-JUN-1999", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-1999", "St. Johns Day");

		lh.addStaticHoliday ("25-JUN-1999", "Bridging Day");

		lh.addStaticHoliday ("18-NOV-1999", "Independence Day");
		...
		lh.addStaticHoliday ("18-NOV-2002", "Independence Day");

		lh.addStaticHoliday ("25-DEC-2002", "Christmas Day");

		lh.addStaticHoliday ("26-DEC-2002", "Boxing Day");

		lh.addStaticHoliday ("27-DEC-2002", "Bridging Day");
		...
		lh.addStaticHoliday ("23-JUN-2003", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2003", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-2003", "Independence Day");
		...
		lh.addStaticHoliday ("23-JUN-2004", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2004", "St. Johns Day");

		lh.addStaticHoliday ("25-JUN-2004", "Bridging Day");

		lh.addStaticHoliday ("18-NOV-2004", "Independence Day");

		lh.addStaticHoliday ("31-DEC-2004", "New Years Eve");

		lh.addStaticHoliday ("25-MAR-2005", "Good Friday");

		lh.addStaticHoliday ("23-JUN-2005", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2005", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-2005", "Independence Day");
		...
		lh.addStaticHoliday ("23-JUN-2008", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2008", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-2008", "Independence Day");
		...
		lh.addStaticHoliday ("23-JUN-2009", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2009", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-2009", "Independence Day");
		...
		lh.addStaticHoliday ("23-JUN-2010", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2010", "St. Johns Day");

		lh.addStaticHoliday ("25-JUN-2010", "Bridging Day");

		lh.addStaticHoliday ("18-NOV-2010", "Independence Day");

		lh.addStaticHoliday ("31-DEC-2010", "New Years Eve");

		lh.addStaticHoliday ("22-APR-2011", "Good Friday");

		lh.addStaticHoliday ("23-JUN-2011", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2011", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-2011", "Independence Day");
		...
		lh.addStaticHoliday ("18-NOV-2013", "Independence Day");

		lh.addStaticHoliday ("25-DEC-2013", "Christmas Day");

		lh.addStaticHoliday ("26-DEC-2013", "Boxing Day");

		lh.addStaticHoliday ("27-DEC-2013", "Bridging Day");
		...
		lh.addStaticHoliday ("23-JUN-2014", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2014", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-2014", "Independence Day");
		...
		lh.addStaticHoliday ("23-JUN-2015", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2015", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-2015", "Independence Day");
		...
		lh.addStaticHoliday ("23-JUN-2016", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2016", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-2016", "Independence Day");
		...
		lh.addStaticHoliday ("18-NOV-2019", "Independence Day");

		lh.addStaticHoliday ("25-DEC-2019", "Christmas Day");

		lh.addStaticHoliday ("26-DEC-2019", "Boxing Day");

		lh.addStaticHoliday ("27-DEC-2019", "Bridging Day");
		...
		lh.addStaticHoliday ("23-JUN-2020", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2020", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-2020", "Independence Day");
		...
		lh.addStaticHoliday ("23-JUN-2021", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2021", "St. Johns Day");

		lh.addStaticHoliday ("25-JUN-2021", "Bridging Day");

		lh.addStaticHoliday ("18-NOV-2021", "Independence Day");

		lh.addStaticHoliday ("31-DEC-2021", "New Years Eve");

		lh.addStaticHoliday ("15-APR-2022", "Good Friday");

		lh.addStaticHoliday ("23-JUN-2022", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2022", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-2022", "Independence Day");
		...
		lh.addStaticHoliday ("18-NOV-2024", "Independence Day");

		lh.addStaticHoliday ("25-DEC-2024", "Christmas Day");

		lh.addStaticHoliday ("26-DEC-2024", "Boxing Day");

		lh.addStaticHoliday ("27-DEC-2024", "Bridging Day");
		...
		lh.addStaticHoliday ("23-JUN-2025", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2025", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-2025", "Independence Day");
		...
		lh.addStaticHoliday ("23-JUN-2026", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2026", "St. Johns Day");

		lh.addStaticHoliday ("18-NOV-2026", "Independence Day");
		...
		lh.addStaticHoliday ("23-JUN-2027", "Midsummers Eve");

		lh.addStaticHoliday ("24-JUN-2027", "St. Johns Day");

		lh.addStaticHoliday ("25-JUN-2027", "Bridging Day");

		lh.addStaticHoliday ("18-NOV-2027", "Independence Day");
