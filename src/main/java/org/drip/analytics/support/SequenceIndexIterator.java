...
public class SequenceIndexIterator {
	...
	{
		if (null == (_aiMax = aiMax)) throw new java.lang.Exception ("IndexIterator ctr => Invalid Inputs");
		...
		if (0 == iNumSequence) throw new java.lang.Exception ("IndexIterator ctr => Invalid Inputs");

		for (int i = 0; i < iNumSequence; ++i) {
			if (0 > _aiMax[i]) throw new java.lang.Exception ("IndexIterator ctr => Invalid Inputs");
		}
	}
