...
public class FixedPointFinderZheng extends org.drip.function.solverR1ToR1.FixedPointFinderBracketing {
	...
	{
		double dblVariateMid = org.drip.function.solverR1ToR1.VariateIteratorPrimitive.Bisection (dblCurrentVariate,
			dblContraVariate);
		...
		if (dblCurrentOF != dblOF && dblContraPointOF != dblOF)
			dblNextVariate = org.drip.function.solverR1ToR1.VariateIteratorPrimitive.InverseQuadraticInterpolation
				(dblCurrentVariate, dblVariateMid, dblContraVariate, dblCurrentOF, dblOF, dblContraPointOF);
		else
			dblNextVariate = org.drip.function.solverR1ToR1.VariateIteratorPrimitive.FalsePosition (dblCurrentVariate,
	...
	public FixedPointFinderZheng (
		...
		throws java.lang.Exception
	{
		super (dblOFGoal, of, null, org.drip.function.solverR1ToR1.VariateIteratorPrimitive.BISECTION, bWhine);
	}
}
