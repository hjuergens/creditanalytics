...
public class BracketingOutput extends org.drip.function.solverR1ToR1.ExecutionInitializationOutput {
	...
	public org.drip.function.solverR1ToR1.ConvergenceOutput makeConvergenceVariate()
	{
		org.drip.function.solverR1ToR1.ConvergenceOutput cop = null;

		try {
			cop = new org.drip.function.solverR1ToR1.ConvergenceOutput (this);
