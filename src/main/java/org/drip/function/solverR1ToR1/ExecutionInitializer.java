...
public class ExecutionInitializer {
	...
	private org.drip.function.solverR1ToR1.ConvergenceControlParams _ccp = null;
	...
	private StartingVariateOF validateVariate (
		final double dblVariate,
		final org.drip.function.solverR1ToR1.BracketingOutput bop)
	{
		...
		final org.drip.function.solverR1ToR1.BracketingOutput bop)
	{
			...
			if (org.drip.quant.common.NumberUtil.IsValid (dblVariatePrev) &&
				...
				try {
					bop.done (dblVariatePrev, dblVariate, dblOFPrev, dblOF,
						org.drip.function.solverR1ToR1.VariateIteratorPrimitive.Bisection (dblVariatePrev,
							dblVariate));
				} catch (java.lang.Exception e) {
				}
		...
		try {
			bop.done (dblVariateLeft, dblVariateRight, dblOFLeft, dblOFRight,
				org.drip.function.solverR1ToR1.VariateIteratorPrimitive.Bisection (dblVariateLeft, dblVariateRight));
		} catch (java.lang.Exception e) {
		}
	...
	private boolean isInConvergenceZone (
		...
		final double dblOFGoal,
		final org.drip.function.solverR1ToR1.ConvergenceOutput cop)
		throws java.lang.Exception
	{
		if (!cop.incrOFCalcs())
	...
	private double getStartingBracketVariate (
		final org.drip.function.solverR1ToR1.BracketingControlParams bcp,
		final org.drip.function.solverR1ToR1.InitializationHeuristics ih)
	{
	...
	public ExecutionInitializer (
		...
		final org.drip.function.solverR1ToR1.ConvergenceControlParams ccp,
		...
		throws java.lang.Exception
	{
		...
		if (null == (_ccp = ccp)) _ccp = new org.drip.function.solverR1ToR1.ConvergenceControlParams();
	...
	public org.drip.function.solverR1ToR1.BracketingOutput initializeBracket (
		final org.drip.function.solverR1ToR1.InitializationHeuristics ih,
		final double dblOFGoal)
	{
		org.drip.function.solverR1ToR1.BracketingControlParams bcp = (null != ih && null != ih.getCustomBCP()) ?
			ih.getCustomBCP() : new org.drip.function.solverR1ToR1.BracketingControlParams();

		int iNumExpansions = bcp.getNumExpansions();

		org.drip.function.solverR1ToR1.BracketingOutput bop = new org.drip.function.solverR1ToR1.BracketingOutput();
	...
	public org.drip.function.solverR1ToR1.ConvergenceOutput initializeVariate (
		final org.drip.function.solverR1ToR1.InitializationHeuristics ih,
		final double dblOFGoal)
	{
		if (!org.drip.quant.common.NumberUtil.IsValid (dblOFGoal)) return null;

		org.drip.function.solverR1ToR1.ConvergenceOutput cop = new org.drip.function.solverR1ToR1.ConvergenceOutput();

		org.drip.function.solverR1ToR1.BracketingOutput bop = initializeBracket (ih, dblOFGoal);
	...
	public org.drip.function.solverR1ToR1.BracketingOutput verifyHardSearchEdges (
		final org.drip.function.solverR1ToR1.InitializationHeuristics ih,
		final double dblOFGoal)
	{
