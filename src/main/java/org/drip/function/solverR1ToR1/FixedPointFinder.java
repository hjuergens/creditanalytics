...
public abstract class FixedPointFinder {
	...
	protected org.drip.function.solverR1ToR1.ExecutionControl _ec = null;
		...
		throws java.lang.Exception
	{
		...
		_ec = new org.drip.function.solverR1ToR1.ExecutionControl (of, null);
	...
	protected abstract org.drip.function.solverR1ToR1.ExecutionInitializationOutput initializeVariateZone (
	...
	public org.drip.function.solverR1ToR1.FixedPointFinderOutput findRoot (
		final org.drip.function.solverR1ToR1.InitializationHeuristics ih)
	{
		org.drip.function.solverR1ToR1.FixedPointFinderOutput rfop = null;

		org.drip.function.solverR1ToR1.ExecutionInitializationOutput eiop = initializeVariateZone (ih);

		if (null == eiop || !eiop.isDone()) return null;

		try {
			rfop = new org.drip.function.solverR1ToR1.FixedPointFinderOutput (eiop);
			...
			org.drip.function.solverR1ToR1.IteratedVariate iv = new org.drip.function.solverR1ToR1.IteratedVariate (eiop,
				dblOF);
