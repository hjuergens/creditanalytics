...
public abstract class R1ToR1 {
	...
	public org.drip.function.definition.VariateOutputPair maxima()
	{
		...
		try {
			org.drip.function.solverR1ToR1.FixedPointFinder fpf = new
				org.drip.function.solverR1ToR1.FixedPointFinderZheng (0., auDerivative, false);

			org.drip.function.solverR1ToR1.FixedPointFinderOutput fpfo = fpf.findRoot();
